...
class RepeatedRPSState(State):
    ...
    def get_state_string(self):
        return f"Repeated RPS state - Round: {self.round} Actions played: {[str(actions) for actions in self.actions_played]}" + (" Value: " + str(self.value) if self.is_terminal() else "")
